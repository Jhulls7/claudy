...
const DB = {
  ...
  defaults: {
    tasks: [
      {id:1,title:'Preparar material del colegio',cat:'colegio',time:'08:30',done:false,priority:true,note:'',subtasks:[],deadline:'',xp:10,postponed:false,created:Date.now()},
      {id:2,title:'Avanzar módulo del proyecto',cat:'proyecto',time:'22:30',done:false,priority:true,note:'Deep work nocturno 2-3h',subtasks:[{t:'Definir arquitectura',d:false},{t:'Primer endpoint',d:false}],deadline:'',xp:25,postponed:false,created:Date.now()},
      ...
      {id:4,title:'Gym 💪',cat:'gym',time:'14:30',done:false,priority:false,note:'Según el día: pecho/espalda/piernas',subtasks:[],deadline:'',xp:15,postponed:false,created:Date.now()},
    ],
    habits: [
      ...
      {id:103,title:'Gym (Lun/Mié/Vie)',emoji:'💪',cat:'salud',done:false,streak:1,bestStreak:8,history:[],target:'daily'},
    ...
    goals: [
      ...
      {id:203,title:'Gym 3x/semana por 3 meses',emoji:'💪',cat:'salud',progress:20,target:100,deadline:'2026-08-15',done:false,milestones:[{t:'Mes 1 completado',d:false},{t:'Mes 2 completado',d:false},{t:'Mes 3 completado',d:false}],xp:150,created:Date.now()},
      {id:204,title:'Plan de trading documentado',emoji:'📊',cat:'trading',progress:5,target:100,deadline:'2026-06-30',done:false,milestones:[{t:'Definir estrategia',d:false},{t:'Backtest 30 días',d:false},{t:'Plan de gestión de riesgo',d:false}],xp:100,created:Date.now()},
      {id:205,title:'Dormir antes de la 1am — 30 días',emoji:'🌙',cat:'salud',progress:10,target:100,deadline:'2026-06-20',done:false,milestones:[{t:'1 semana',d:false},{t:'2 semanas',d:false},{t:'1 mes completo',d:false}],xp:80,created:Date.now()},
    ],
    health: { weight:65, sleep:[], water:[], mood:[], gym_sessions:[], weight_log:[] },
    stats:  { xp:0, level:1, streak:0, lastActive:null, tasksCompleted:0, habitsCompleted:0, gymSessions:0, studyHours:0, history:{} },
    settings: { pin:null, name:'Estudiante', notifications:true },
    notifications: [],
    records: { bestTaskDay:0, bestGymWeek:0, bestStreak:0 },
    claude_timers: [],
  },

  load(key){ try{ const r=localStorage.getItem('claudy_'+key); return r?JSON.parse(r):null; }catch(e){return null;} },
  save(key,val){ try{ localStorage.setItem('claudy_'+key,JSON.stringify(val)); return true; }catch(e){return false;} },
  get(key){ return this.load(key)??JSON.parse(JSON.stringify(this.defaults[key]??null)); },
  set(key,val){ return this.save(key,val); },
  update(key,fn){ const val=this.get(key); const updated=fn(val); this.set(key,updated??val); return updated??val; },
  clear(){ ['tasks','habits','goals','health','stats','settings','notifications','records','claude_timers'].forEach(k=>localStorage.removeItem('claudy_'+k)); },
  export(){ const d={}; ['tasks','habits','goals','health','stats','settings','notifications','records','claude_timers'].forEach(k=>d[k]=this.get(k)); return JSON.stringify(d,null,2); },
  import(json){ try{ const d=JSON.parse(json); Object.keys(d).forEach(k=>this.set(k,d[k])); return true; }catch(e){return false;} }
};

// ═══════════════════════════════════════════════════════
// HORARIO FIJO SEMANAL — Clases y actividades inamovibles
// Lunes=1, Martes=2, Miércoles=3, Jueves=4, Viernes=5
// JavaScript: Dom=0, Lun=1, Mar=2, Mié=3, Jue=4, Vie=5, Sáb=6
// ═══════════════════════════════════════════════════════
const FIXED_SCHEDULE = {
  0: [ // Domingo
    {time:'06:00',end:'10:00',label:'Libre — recarga total',type:'free'},
    {time:'10:00',end:'13:00',label:'Proyecto (opcional)',type:'project'},
    {time:'13:00',end:'15:00',label:'Almuerzo familiar',type:'personal'},
    {time:'15:00',end:'20:00',label:'Tiempo libre',type:'free'},
  ...
  1: [ // Lunes
    ...
    {time:'06:30',end:'07:00',label:'Rutina matutina',type:'personal'},
    ...
    {time:'14:30',end:'16:00',label:'Gym 💪 — Pecho + hombros + tríceps',type:'gym'},
    {time:'16:00',end:'16:30',label:'Ducha + recuperación',type:'personal'},
    {time:'16:30',end:'18:15',label:'Libre / proyecto',type:'project'},
    {time:'18:15',end:'18:30',label:'Traslado a U',type:'travel'},
    ...
    {time:'21:45',end:'22:30',label:'Vuelta + cena',type:'travel'},
  ...
  2: [ // Martes
    ...
    {time:'09:00',end:'14:00',label:'Colegio — apoyo docente',type:'fixed'},
    {time:'14:00',end:'14:30',label:'Almuerzo',type:'personal'},
    {time:'14:30',end:'17:40',label:'Proyecto de software 💻',type:'project'},
  ...
  3: [ // Miércoles
    ...
    {time:'09:00',end:'14:00',label:'Colegio — apoyo docente',type:'fixed'},
    {time:'14:00',end:'14:30',label:'Almuerzo',type:'personal'},
    {time:'14:30',end:'16:00',label:'Gym 💪 — Espalda + bíceps + core',type:'gym'},
    {time:'16:00',end:'16:30',label:'Ducha + recuperación',type:'personal'},
    {time:'16:30',end:'18:15',label:'Libre / proyecto',type:'project'},
    {time:'18:15',end:'18:30',label:'Traslado a U',type:'travel'},
  ...
  5: [ // Viernes
    ...
    {time:'16:00',end:'16:30',label:'Ducha + recuperación',type:'personal'},
    {time:'16:30',end:'17:40',label:'Libre / proyecto',type:'project'},
    {time:'17:40',end:'18:00',label:'Traslado a U',type:'travel'},
  ...
  6: [ // Sábado
    {time:'06:00',end:'08:00',label:'Libre — sin alarma',type:'free'},
